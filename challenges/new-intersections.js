...
// Loop through the inputs, checking to see when the x or y values match those of the new point
// When matched, check to see where the old point lies relative to new
// Verify that there are old points above, below, left and right
